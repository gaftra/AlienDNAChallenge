#Solves the 10k genome using a horrible method
...
for x in range(100):
	...
	if sn[0] == "BC" and sn[1] != None:
		n = findMatch(file_arrayBC,sn[1]) + n
	if sn[0] == "DE" and sn[1] != None:
		n = findMatch(file_arrayDE,sn[1]) + n
	if sn[0] == "DFAD" and sn[1] != None:
		n = findMatch(file_arrayDFAD,sn[1]) + n
	if sn[0] == "EDA" and sn[1] != None:
		n = findMatch(file_arrayEDA,sn[1]) + n
	print len(n)
	c += 1
